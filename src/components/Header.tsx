    ...
    <>
          ...
          <div className='flex flex-1 items-center justify-end md:justify-between'>
            ...
            <div className='flex items-center gap-4'>
              <div className='sm:flex sm:gap-4'>
                <button
                  className='block rounded-md bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-indigo-300 dark:hover:bg-indigo-500'
      ...
      {modalOpen && (
        <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/75'>
          <div className='bg-white dark:bg-gray-900 rounded-lg shadow-lg p-8 w-full max-w-md mx-4 relative'>
            <button
